...
class TestRampartSession:
    ...
    def test_record_trial_group(self) -> None:
        ...
        assert group.threshold == pytest.approx(0.3)  # pyright: ignore[reportUnknownMemberType]
    ...
    def test_record_trial_group_all_errors(self) -> None:
        ...
        assert group.pass_rate == pytest.approx(0.0)  # pyright: ignore[reportUnknownMemberType]
...
class TestRampartSessionDuration:
    ...
    def test_set_duration_reflected_in_report(self) -> None:
        ...
        report = session.build_report()
        assert report.duration_seconds == pytest.approx(42.5)  # pyright: ignore[reportUnknownMemberType]
